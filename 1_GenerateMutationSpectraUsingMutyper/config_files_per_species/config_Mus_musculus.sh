...
species=Mus_musculus # changing this from mice to be mus musculus 
...
vcfdir="/net/harris/vol1/home/beichman/mice/analyses/keightley_polarization/20210225_focalMmd_out1Mmm_out2Ms/vcfs_with_ancestral_alleles_KimuraModel_assignedUsingProbs/perChromosome/"
vcffilename="chr${interval}.AncAllelesFromExtSFSAssignedUsingProbs.KimuraModel.BiallelicSNPsOnly.BUGFIX.AllMouse.vcf_90_recalibrated_snps_raw_indels_reheader_PopSorted.PASS.vcf.gz"
...
# note, these vcfs still have Ms in them but am not subsetting it out here ; but will affect missign data (I think that's good, want to be sites that are called in all the mice)
...
ancestralFastaDir="/net/harris/vol1/home/beichman/mice/analyses/ancestralReferenceFastas/20210225_focalMmd_out1Mmm_out2Ms_KimuraModel_AncAlleleAssignedUsingProbs/"
ancestralFastafilename="FINAL.MODIFIED.ANCESTRAL.chr${interval}_mouseAncestral_extSFS_assignedUsingProbs.BUGFIX.fasta"
...
pops='Mmd Mmc Mmm' # note: now excluding Ms because am doing it with its own config file
