...
vcfdir="/net/harris/vol1/home/beichman/bears/analyses/keightley_polarization/20220607_Keightley_focalbrown_bear_out1polar_bear_out2black_bear/vcfs_with_ancestral_alleles/perInterval/"
vcffilename="interval_${interval}.AncAllelesFromExtSFSAssignedUsingProbs.KimuraModel.BUGFIX.SNPs.filt_variants_4b.LowCovIndsREMOVED.nomissfiltapplied.PASS.WARN.Only.CustomFilt.HardFilt.AnnotVar.TrimAlt.ref_brown_bear.int_${interval}.vcf.gz"
...
# note: these files still contain polar bear samples (and black bear?) so that will affect missing data (both bb and pb even tho pol separately will be called at same sites, I think that's good)
# but only pulling out the BB pops from this file 
...
ancestralFastaDir="/net/harris/vol1/home/beichman/bears/analyses/ancestralReferenceFastas/20220607_Keightley_focalbrown_bear_out1polar_bear_out2black_bear_assignedAllelesUsingProbs_POLARIZING_brown_bear/"
ancestralFastafilename="FINAL.MODIFIED.ANCESTRAL.interval_${interval}_brown_bearAncestral_extSFS_AllelesAssignedUsingProbs.BUGFIX.fasta"
...
pops='EUR ABC' # maybe keep PB in as a comparison? for now , not doing that..
