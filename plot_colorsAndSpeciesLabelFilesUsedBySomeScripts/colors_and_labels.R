...
#niceLabels= data.frame(label=c("bears_ABC","bears_EUR","bears_PB","fin_whale_ENP","fin_whale_GOC","Gorilla_gorilla","humans_AFR","humans_AMR","humans_EAS","humans_EUR","humans_SAS","mice_Mmc","mice_Mmd","mice_Mmm","mice_Ms","Pan_paniscus","Pan_troglodytes", "Pongo_abelii","Pongo_pygmaeus","vaquita","wolves"),niceLabel=c("brown bear (ABC)","brown bear (EUR)","polar bear","fin whale (ENP)","fin whale (GOC)","gorilla","human (AFR)","human (AMR)","human (EAS)","human (EUR)","human (SAS)","mouse (Mmc)","mouse (Mmd)","mouse (Mmm)", "mouse (Ms)","bonobo","chimpanzee","orangutan (Sumatran)","orangutan (Bornean)","vaquita","wolf"),shortSpeciesLabel=c("brown bear","brown bear","polar bear","fin whale","fin whale","gorilla","human","human","human","human","human","house mouse","house mouse","house mouse","Algerian mouse","bonobo","chimpanzee","S. orangutan","B. orangutan","vaquita",'wolf'))

# updating after new polariation for ms and mm (separating) and pb and bb (with pb mapped to pb)
niceLabels= data.frame(label=c("brown_bear_ABC","brown_bear_EUR","polar_bear_PB","fin_whale_ENP","fin_whale_GOC","Gorilla_gorilla","humans_AFR","humans_AMR","humans_EAS","humans_EUR","humans_SAS","Mus_musculus_Mmc","Mus_musculus_Mmd","Mus_musculus_Mmm","Mus_spretus_Ms","Pan_paniscus","Pan_troglodytes", "Pongo_abelii","Pongo_pygmaeus","vaquita","wolves"),niceLabel=c("brown bear (ABC)","brown bear (EUR)","polar bear","fin whale (ENP)","fin whale (GOC)","gorilla","human (AFR)","human (AMR)","human (EAS)","human (EUR)","human (SAS)","mouse (Mmc)","mouse (Mmd)","mouse (Mmm)", "mouse (Ms)","bonobo","chimpanzee","orangutan (Sumatran)","orangutan (Bornean)","vaquita","wolf"),shortSpeciesLabel=c("brown bear","brown bear","polar bear","fin whale","fin whale","gorilla","human","human","human","human","human","house mouse","house mouse","house mouse","Algerian mouse","bonobo","chimpanzee","S. orangutan","B. orangutan","vaquita",'wolf'))
