...
Fake5merArrayPlotComparedToEmpirical<-ggplot(mantel_pearsonROnly_Fake5mer_ARRAY_df,aes(x=statistic))+
  ...
  annotate("text",x=0.8,y=450,label=paste0("p-value: ",round(pValOnFake5merArrayRValuesGreaterThanEmpirical,5)))+
  theme_bw()  +
...
Fake7merArrayPlotComparedToEmpirical<-ggplot(mantel_pearsonROnly_Fake7mer_ARRAY_df,aes(x=statistic))+
  ...
  annotate("text",x=0.72,y=400,label=paste0("p-value: ",round(pValOnFake7merArrayRValuesGreaterThanEmpirical,3)))+
  theme_bw()+
  xlab("Pearson's r\n(correlation between permuted spectra\nand sqrt phylogenetic distance)")+
  ylab("count")+
  theme(legend.position="none")
...
fake5mer7merdistributionPlotsArrange
