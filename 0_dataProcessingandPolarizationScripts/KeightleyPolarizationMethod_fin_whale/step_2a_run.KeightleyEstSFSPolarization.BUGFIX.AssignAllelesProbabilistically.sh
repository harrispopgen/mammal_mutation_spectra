...
indir=/net/harris/vol1/home/beichman/fin_whale/analyses/keightley_polarization/$flagForThisRun/input_tables_separated100K/interval_${intervalID}
...
#vcffilename=$vcfdir/JointCalls_f50b4_08_B_VariantFiltration_${SGE_TASK_ID}.vcf.gz 
...
############## CHOOSE ANC ALLELE : THIS STEP IS TEMPORARY AND CAN BE IMPROVED: ##############
...
inprefix=KimuraModel.10MLRuns.interval_${intervalID}.focal.${focal}.out1.${outgroup1}.out2.${outgroup2}.PreppedForExtsfs.txt # fin whale has this longer prefix 
