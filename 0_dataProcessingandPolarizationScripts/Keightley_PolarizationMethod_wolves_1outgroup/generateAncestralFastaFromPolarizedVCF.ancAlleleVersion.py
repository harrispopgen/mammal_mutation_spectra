...
def make_ancestral_fasta_fromVCFAA(vcffilename,mutablefastaname):
    ...
    for variant in cyvcf2.VCF(vcffilename):
        ...
        # make sure the scaffold is in the fasta file
            ...
            # AB 20230204 --> this old comment of mine isn't very clear -- the coordinates of pyfaidx are start-1 (later note, did I mean start-1?) and end =end (like bed file) so if you do [200:230] you'll get back vcf 1-based sites 201-230 I think. The manual states this in an unclear manner
