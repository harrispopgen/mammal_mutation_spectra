...
ancFastascript=$gitdir/keightley_polarization/generateAncestralFastaFromPolarizedVCF.ancAlleleVersion.py
...
vcf=$wd/vcfs_with_ancestral_alleles/wolves_only/AncAllelesFromExtSFSAssignedUsingProbs.KimuraModel.BUGFIX.excludingCoyote.wolf_coyote_notallwolves.biallelicsnpsonly.keepingmonomorphicbecausepolyindogs.vcf.gz
